...
export function EditProductFormMultiStep({ product, categories }: EditProductFormMultiStepProps) {
        ...
        return (
          ...
          >
            ...
            <div className="flex gap-4 pt-2">
              ...
              >
                {loading ? <><Loader2 className="h-5 w-5 animate-spin" /> Updating...</> : <><Save className="h-5 w-5" /> Update Product</>}
              </Button>
            </div>
          </motion.div>
        );
