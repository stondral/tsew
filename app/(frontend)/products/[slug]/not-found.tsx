...
export default function ProductNotFound() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-amber-50/30 flex items-center justify-center px-4 pt-24 pb-12">
      <div className="max-w-2xl w-full text-center">
        ...
        <div className="mb-8 flex justify-center">
          <div className="relative">
            ...
            <div className="relative bg-white p-8 rounded-full shadow-2xl shadow-slate-200/50 border border-slate-100">
              <Package className="h-24 w-24 text-slate-300" strokeWidth={1.5} />
            </div>
          </div>
        </div>
        ...
        <p className="text-sm text-slate-500 mb-12 max-w-md mx-auto">
          This could be because the product is no longer available, the link is incorrect, or it may have been moved to a different location.
        </p>
