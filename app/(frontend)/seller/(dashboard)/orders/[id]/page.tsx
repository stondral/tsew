                  ...
                  <div className="flex justify-between items-center text-[13px] text-emerald-400">
                    <div className="flex flex-col">
                      <span className="font-bold uppercase tracking-[0.2em] text-[10px]">
                        Discount ({order.discountSource === 'seller' ? 'Seller Component' : 'Store Reward'})
                      </span>
                      {order.discountCode && (
                        <span className="text-[8px] font-black opacity-60 uppercase tracking-widest">{order.discountCode}</span>
                      )}
                    </div>
                    <span className="font-black tracking-tight">-₹{order.discountAmount.toFixed(2)}</span>
                  </div>
                )}
